...
public class Chain {
	...
	public static void main(String[] args) {
		...
		Security.addProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider()); //Setup Bouncey castle as a Security Provider //for private key and public key
